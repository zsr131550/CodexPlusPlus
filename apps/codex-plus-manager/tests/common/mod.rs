...
pub fn desktop_integration_state(
    needs_repair: bool,
    legacy_enabled: bool,
) -> codex_plus_manager::state::desktop_integration::DesktopIntegrationViewState {
    let mut state =
        codex_plus_manager::state::desktop_integration::DesktopIntegrationViewState::default();
