...
use codex_plus_manager::state::marketplace::MarketplaceViewState;
use codex_plus_manager::theme;
use codex_plus_manager::views::marketplace::{self, MarketplaceAction};
...
fn repair_failure_is_shown_only_on_the_target_row() {
    ...
    state.apply_repair_response(
        ...
        Err(
            codex_plus_manager::state::marketplace::MarketplaceFailureKind::Service(
