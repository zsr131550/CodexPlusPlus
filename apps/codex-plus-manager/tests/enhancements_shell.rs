...
use codex_plus_manager::state::enhancements::EnhancementViewState;
use codex_plus_manager::theme;
use codex_plus_manager::views::shell::{ShellAction, ShellFeatureStates, render_shell};
...
struct ShellState {
    model: codex_plus_manager::views::shell::ShellViewModel,
