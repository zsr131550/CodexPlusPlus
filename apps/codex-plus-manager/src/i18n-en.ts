...
export const EN_PLAIN: Record<string, string> = {
  ...
  "Codex 应用": "Codex app",
  "Codex 应用路径、手动启动与诊断": "Codex app path, manual launch, and diagnostics",
  ...
  "已刷新 Codex 应用和入口状态。": "Refreshed Codex app and entrypoint status.",
  "已受理": "Accepted",
  "已安装": "Installed",
  "已归档": "Archived",
  ...
  "检查": "Check",
  "检查 Codex 应用和入口状态": "Check Codex app and entrypoint status",
